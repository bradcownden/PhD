...
We have now seen how renormalization flow equations that arise in the TTF allow for secular terms to be absorbed into the definitions of the slowly varying amplitude and phases variables, thereby ensuring stability to $\mc O(\epsilon^3)$ in the perturbative theory of scalar field collapse. By calculating the source term at third order, we can construct numerical solutions for quasi-periodic states in the truncated system and examine their evolution.

{\bf DISCUSSION OF BEYOND SPHERICAL SYMMETRY HERE?} 

So far, we have only considered gravitational systems whose holographic duals are narrowly constrained to single quenches. However, to better understand more general systems, we wish to extend the perturbative description of the gravitational theory beyond massless scalars with static boundary conditions to include all allowed masses (both positive and negative mass-squared), as well as time-dependent driving terms on the conformal boundary. This is the focus of the following project: to derive a perturbative theory for a more general class of scalar fields and to examine the effects of time-dependent sources for the fields. 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Contributions}

As sole author of this publication, all work is mine: derivations, numerical results, and writing the manuscript.
...
\bigskip
{\bf \href{http://arxiv.org/abs/1912.07143}{arXiv:1912.07143}} \\
\bigskip
\bigskip
Brad Cownden$^1$\\
\bigskip
...
\begin{figure}
\centering
	\includegraphics[width=\textwidth]{/Users/bradc/Research/Thesis/PhD/Chapter3/figs/Nmodesplot}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{/Users/bradc/Research/Thesis/PhD/Chapter3/figs/NN_equalfreq_sourceterms_m-1_0+zoom}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{/Users/bradc/Research/Thesis/PhD/Chapter3/figs/NNAddToInteger_source_n2_m-1_0}
