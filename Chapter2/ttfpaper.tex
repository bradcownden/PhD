...
\begin{figure}[ht]
	...
	\begin{subfigure}[t]{0.47\textwidth}
		...
		\caption{Applying repeated energy perturbations to the initial solution with $\alpha_1=0.44$, projecting back to the QP surface every five iterations.}
	...
	\begin{subfigure}[t]{0.47\textwidth}
		...
		\caption{Beginning with the same $\alpha_1 = 0.44$ QP solution, repeated energy perturbations are again applied, this time projecting back to the QP surface every 20 iterations.}
