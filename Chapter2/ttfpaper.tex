...
Reference to TTF, resummation, etc.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Contributions}

Using the Two-Time Formalism, this work examines the persistence of families of solutions to the perturbative description of the gravitational collapse of a massless scalar field. 
