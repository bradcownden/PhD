...
\frame
{
  ...
  \its Interior gauge $\delta(t, x=0) = 0$
  \its Horizon formation when $A(t_H, x_H) \leq 2^{7-n}$
...
\frame
{
   ...
   \bi
   \its Examine the stability of AdS to scalar field collapse in various dimensions in perturbative \& non-perturbative regimes 
   \its Addition of time-dependent boundary conditions to TTF description
