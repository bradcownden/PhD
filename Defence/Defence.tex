...
\frame
{
  ...
  \begin{columns}
    ...
    \begin{figure}
      \centering
      \only<1>{\includegraphics[width=\textwidth]{m0w15} \\ $\mu =0$, $\sigma =1.5$}
      \only<2>{\includegraphics[width=\textwidth]{m0w025} \\ $\mu = 5$, $\sigma=0.25$}
    \end{figure}
 \end{columns}
}
...
\frame
{
  ...
  \begin{columns}
    ...
    \begin{figure}
      \centering
      \only<1>{\includegraphics[width=\textwidth]{m5w17} \\ $\mu = 5$, $\sigma = 1.7$}
      \only<2>{\includegraphics[width=\textwidth]{m20w016} \\ $\mu = 20$, $\sigma = 0.16$}
    \end{figure}
 \end{columns}
 \vfill
}
...
\frame
{
  ...
  \begin{figure}
  \centering
    \only<1>{\includegraphics[width=\textwidth]{families}}
    \only<2>{\includegraphics[width=\textwidth]{largejmax}}
  \end{figure}
  \end{columns}
...
\frac{2 \omega_\ell}{\mathcal A_1 \mathcal A_2 \epsilon^2} \frac{d a_\ell}{dt} &= \sum_{(++)} f^{(\ell)}_{(++)} a_{n - \ell - d} \sin \left(b_{n-\ell - d} - \mathcal B_1 - \mathcal B_2\right) \\ 
	& \!\!\!\! + \sum_{(+-)} f^{(\ell)}_{(+-)} a_{\ell - n} \sin \left( b_{\ell - n} - \mathcal B_1 - \mathcal B_2 \right) 
	  + \sum_{(-+)} f^{(\ell)}_{(-+)} a_{\ell + n} \sin \left( b_{\ell + n} - \mathcal B_1 - \mathcal B_2 \right) \\
	   \frac{1}{\mathcal A_1 \mathcal A_2} \frac{2 \omega_\ell a_\ell}{\epsilon^2} \frac{db_\ell}{dt} &= \sum_{(++)} f^{(\ell)}_{(++)} a_{n - \ell - d} \cos \left(b_{n-\ell - d} - \mathcal B_1 - \mathcal B_2\right)  \\
	 & \!\!\!\! + \sum_{(+-)} f^{(\ell)}_{(+-)} a_{\ell - n} \cos \left(b_{\ell - n} - \mathcal B_1 - \mathcal B_2 \right) 
	  + \sum_{(-+)} f^{(\ell)}_{(-+)} a_{\ell + n} \cos \left( b_{\ell + n} - \mathcal B_1 - \mathcal B_2 \right) + f^{(\ell)} a_\ell
